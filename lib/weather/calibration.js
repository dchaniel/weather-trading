 ...
 *
 * ⚠️  IMPORTANT: Backtest "actual" values come from Open-Meteo historical
 * gridded data, NOT NWS ASOS station observations.  Kalshi settles on ASOS.
 * Open-Meteo vs ASOS can differ by 3-9°F (especially KNYC, KMSP, KDEN).
 *
 * DO NOT use backtest MAE/sigma to calibrate baseSigma — it will be 2-5x
 * too tight.  Use ASOS validation data (data/asos-validation.json) instead.
 * See research/calibrate-sigma-from-asos branch for details.
 */
