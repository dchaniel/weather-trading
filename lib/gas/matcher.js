 ...
 * Raised from 5% to 10% to compensate for EIA→AAA data source mismatch.
 * The ~$0.10 bias correction is approximate; higher min edge provides buffer. */
const MIN_EDGE = 0.20; // 20% — raised because model has no directional edge (49% hit rate)
// Only trade extreme mispricings where data source bias creates obvious arb
